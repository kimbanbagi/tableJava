...
public class NotificationServiceImpl implements NotificationService{
    ...
    // 알림 메세지에 추가 될 사용자, 사장님 별 코멘트 상수 enum
    public enum Comments {
        U_BOOK_A("예약 신청이 완료 되었습니다."), O_BOOK_A("새로운 예약이 들어왔습니다."),
        BOOK_C("예약이 확정 되었습니다."), C_BOOK("예약이 취소 되었습니다."),
        U_BOOK_C("손님 측에서 예약을 취소했습니다."), O_BOOK_C("식당 측에서 예약을 취소했습니다."),
        BOOK_E("예약이 종료 되었습니다."),
        U_WAIT_A("웨이팅 신청이 완료 되었습니다."), O_WAIT_A("새로운 대기 팀이 있습니다."),
        WAIT_C("차례가 되었습니다. 식당에 방문해주세요."), C_WAIT("웨이팅이 취소 되었습니다."),
        U_WAIT_C("손님 측에서 웨이팅을 취소했습니다."), O_WAIT_C("식당 측에서 웨이팅을 취소했습니다."),
        WAIT_E("웨이팅이 종료 되었습니다.");
